				...
				<div class="landing_page_section">
					...
					<div class="d-flex justify-content-center align-items-center flex-column cta_container">
						...
						<div class="cta_buttons">
							<button-component data-text='GET STARTED' onclick="GoTo('/signup/')"> </button-component>
							<button-component data-text='I ALREADY HAVE AN ACCOUNT' data-type="no-bg" onclick="GoTo('/login/')"> </button-component>
						</div>
