...
export default class Tournament_Match extends HTMLElement {
    ...
    constructor() {
        ...
        this.roomname = new URLSearchParams(location.search).get("tournament_name")
        
        makeRequest(`/api/tournaments/tournament_rooms/?tournament_name=${this.roomname}`, 'GET').then(data =>{
            console.log(data)
            this.innerHTML = /*html*/`
