        ...
        this.innerHTML = /* html */`
            ...
            <form>
                ...
                <div class="inputs_2fa">
                    <input type="text" name="first_char_2fa" class="header_h3 input_2fa" maxlength="1">
                    <input type="text" name="first_char_2fa" class="header_h3 input_2fa" maxlength="1">
                    <input type="text" name="first_char_2fa" class="header_h3 input_2fa" maxlength="1">
                    <input type="text" name="first_char_2fa" class="header_h3 input_2fa" maxlength="1">
                    <input type="text" name="first_char_2fa" class="header_h3 input_2fa" maxlength="1">
                ...
                <button-component class="login_button" data-text="Submit" onclick="GoTo('/signup/')"></button-component>
            </form>
        </div>
        `;
    }
